...
- _Issue date_: The date identifying the forecast's _version_. If there is more than one version for this forecast's timezero then text like "Version 1 of 2" will show in the Version column. (See [Forecast Versions](ForecastVersions.md) for more about versions.)
